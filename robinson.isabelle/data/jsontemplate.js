...
[
  '{{repeat(50)}}',
  {
    ...
    breed: function(tags) {
      var breeds = {
        small:["yorkie","shitzu","chihuahua"],
       medium:["doodle","portuguese water dog","wheaton terrier"],
        large:["golden retriever","bernese mountain dog","great dane"]
      };
...
[
  '{{repeat(250)}}',
  {
    ...
    lat:'{{floating(37.800152,37.750660)}}',
    lng:'{{floating( -122.496938,-122.371687)}}',
